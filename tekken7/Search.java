...
//            System.out.println(new File("src\\main\\java\\tekken7\\TEKKEN7.json\\"+charaName+".json").getAbsolutePath());
            JsonNode search = mapper.readTree(new File(new File("src\\main\\java\\tekken7\\TEKKEN7.json\\"+charaName+".json").getAbsolutePath()));//JsonNode型でpokemon.jsonを読み込み、使えるようにする
